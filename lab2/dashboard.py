...
PORT_THRESHOLD = os.getenv("NETWORK_SCAN_PORT_THRESHOLD", "4")
...
<strong>STIX loaded at:</strong> {escape(knowledge.get("loaded_at") or "Not loaded")}<br>
<strong>Network Scan Port Threshold:</strong> {escape(PORT_THRESHOLD)}
</div>
